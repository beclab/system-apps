...
const option = {
	...
	PERMISSION_WORKSPACES_MANAGEMENT_DESC:
	...
	PASSWORD_STRENGTH_DESC:
		'Avoid using weak passwords or passwords of other accounts.',
	TIME: 'Time',
	...
	CPU_VALUE: 'CPU: {value} core | {value} cores',
	...
	PERMISSION_VOLUME_SNAPSHOT_CLASSES_MANAGEMENT:
	...
	RESOURCE_DEPLOYMENT_LOCATION_NOT_SELECTED:
		'No resource deployment locations are selected.',
	...
	PERMISSION_CREDENTIALS_MANAGEMENT_DESC:
		'Create, edit, and delete DevOps credentials.',
	...
	PERMISSION_CONTINUOUS_DEPLOYMENTS_VIEW_DESC:
		'View continuous deployments in the DevOps project.',
	PERMISSION_CONTINUOUS_DEPLOYMENTS_MANAGEMENT:
	...
	PERMISSION_CODE_REPOSITORIES_MANAGEMENT_DESC:
	...
	GO_CREATE_REPO:
		'No code repository is available. Please create a code repository.',
	...
	DELETE_OUTDATED_BUILD_RECORDS_TIP:
		'Set the system to automatically delete outdated build records including console output, archived artifacts, and metadata to save disk space.',
	...
	SEND_TEST_MESSAGE_SUCCESS_DESC:
		'Verified successfully. A test message has been sent.',
	...
	RECIPIENT_SETTINGS_TIP:
		'Enter at least one user ID, department ID, or tag ID.',
	...
	CHANNEL_EXISTS:
		'The Slack channel already exists. Please add another Slack channel.',
	...
	NO_DATA_AUTHORIZED_DESC:
		'Please contact an administrator to obtain data authorization.',
	...
	OPEN_TERMINAL_DESC:
		'Ensure that the web socket settings on the proxy server is correct.',
	TOOLBOX: 'Toolbox',
	TOOLBOX_DESC: 'Provides cluster analysis and control tools.',
	DETAIL_NOT_FOUND_DESC:
		'No related resources were found. <a href="{link}">Return to {title}</a>',
	...
	VIEW: 'View',
	CONSUMPTION_SINCE_CREATION:
		'has consumed the following resources since it is created.',
	PRICE: 'Price',
	...
	SUBMIT_REVIEW_DESC:
		'Submit the app template for review before releasing it to the App Store.',
	APP_LEARN_MORE:
	...
	DEVOPS_BASEINFO_DESC:
		'Please set the basic information of the DevOps project',
	...
	PERMISSION_PROJECTS_MANAGEMENT_DESC:
	...
	PERMISSION_WORKSPACE_APP_REPOS_VIEW_DESC:
		'View app repositories in the workspace.',
	...
	PERMISSION_WORKSPACE_APP_TEMPLATES_VIEW_DESC:
		'View app templates in the workspace.',
	...
	PERMISSION_WORKSPACE_GROUPS_VIEW_DESC:
...
export default { ...option, ...middleware, ...analytics };
